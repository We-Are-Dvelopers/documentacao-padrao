...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.categorias.store') }}" method="POST" id="formStore">
            @csrf
            <div class="row align-items-center">
                ...
                <div class="col-3">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" required id="radioDefault2"
                                value="inativo">
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <textarea name="descricao" id="" class="editor"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col">
